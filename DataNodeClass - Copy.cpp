...
{
	return gfDN_GetNodeByPath(this->Ref, iPath, true, false);
	...
	//	DataNodeStruct* _FoundChild = gfDN_GetChildByNameAndIndex_2(this->Ref, iPath, 0);
...
//{
//	this->Children = gfDNCollection_Create(1);
